...
namespace JBLib.Collections.Generic
{
    ...
    {
        private readonly IDictionary<TKey, IList<TItem>> dictionary = new Dictionary<TKey, IList<TItem>>();
        ...
        public IEnumerable<TItem> this[TKey key]
            => dictionary.TryGetValue(key, out var list) ? list : Enumerable.Empty<TItem>();
